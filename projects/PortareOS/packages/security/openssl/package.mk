...
post_makeinstall_target() {
  ...
  mkdir -p ${INSTALL}/usr/bin
    ...
    ln -sf /run/portareos/cacert.pem ${INSTALL}/etc/ssl/cacert.pem
    ln -sf /run/portareos/cacert.pem ${INSTALL}/etc/ssl/cert.pem

  # backwards compatibility
  mkdir -p ${INSTALL}/etc/pki/tls
    ln -sf /run/portareos/cacert.pem ${INSTALL}/etc/pki/tls/cacert.pem
  mkdir -p ${INSTALL}/etc/pki/tls/certs
    ln -sf /run/portareos/cacert.pem ${INSTALL}/etc/pki/tls/certs/ca-bundle.crt
  mkdir -p ${INSTALL}/usr/lib/ssl
    ln -sf /run/portareos/cacert.pem ${INSTALL}/usr/lib/ssl/cert.pem
}
