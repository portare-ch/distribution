...
# The SDL test apps (jstest-sdl, sdljoytest, sdltouchtest, sdl2text) went
# with EmulationStation, whose Tools menu was the only way to start them.
# gamepad-tester covers the same ground and is in the launcher's Tools.
PKG_GAMESUPPORT="sixaxis portareos-hotkey gamecontrollerdb control-gen"
